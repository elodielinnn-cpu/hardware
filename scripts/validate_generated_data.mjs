...
for (const article of articles) {
  ...
  if (article.sourceId === "ithome" && article.showByDefault === true && !ithomeHardSignal.test(articleText)) {
  ...
  if (article.sourceId === "ithome" && article.relevance === "高" && !ithomeHardSignal.test(articleText)) {
